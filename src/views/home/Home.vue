...
const systemModules = computed(() => ({
  ...
  // 下面的目录只在30006环境中才打开。 下列环境修改后统一使用30006
  farm: {
    name: t('home.modules.farm.name'),
    desc: t('home.modules.farm.desc'),
    icon: 'ri-landscape-line',
    gradient: 'linear-gradient(135deg, #52C41A 0%, #95DE64 100%)',
    path: `http://196.189.236.220:30006/prod-api/sso/ssoLogin?contextPath=farmland&token=${localStorage.getItem('token') || ''}`,
    external: true
  },
  production: {
    ...
    path: `http://196.189.236.220:30006/prod-api/sso/ssoLogin?contextPath=production&token=${localStorage.getItem('token') || ''}`,
    external: true
  },
  procurement: {
    ...
    path: `http://196.189.236.220:30006/prod-api/sso/ssoLogin?contextPath=processing&token=${localStorage.getItem('token') || ''}`,
    external: true
  },
  traceability: {
    ...
    path: `http://196.189.236.220:30006/prod-api/sso/ssoLogin?contextPath=logistics&token=${localStorage.getItem('token') || ''}`,
    external: true
  },
  sustainability: {
    ...
    path: `http://196.189.236.220:30006/prod-api/sso/ssoLogin?contextPath=sustainability&token=${localStorage.getItem('token') || ''}`,
    external: true
  },
  harvest: {
    ...
    path: `http://196.189.236.220:30006/prod-api/sso/ssoLogin?contextPath=harvest&token=${localStorage.getItem('token') || ''}`,
    external: true
  },
  marketing: {
    ...
    path: `http://196.189.236.220:30006/?token=${localStorage.getItem('token') || ''}`,
    external: true
  },
  inventory: {
