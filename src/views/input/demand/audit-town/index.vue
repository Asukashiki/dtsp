      ...
      <div class="page-header">
        <div class="header-left">
          ...
          <div class="header-content">
            <h1 class="page-title">{{ $t('townAggregationAudit.title') }}</h1>
            <p class="page-subtitle">{{ $t('townAggregationAudit.subtitle') }}</p>
          </div>
        </div>
        ...
        <div class="info-card">
          <div class="card-header">
            <div class="card-title">
              ...
              <span>{{ $t('townAggregationAudit.listTitle') }}</span>
            </div>
          ...
          <div class="card-body">
            ...
            <div class="table-wrapper pc-only">
              ...
              >
                <el-table-column
                  prop="sourceCode"
                  :label="$t('townAggregationAudit.columns.sourceCode')"
                  min-width="140"
                />
                <el-table-column
                  prop="sourceName"
                  :label="$t('townAggregationAudit.columns.sourceName')"
                  min-width="140"
                />
                <el-table-column
                  prop="targetCode"
                  :label="$t('townAggregationAudit.columns.targetCode')"
                  min-width="140"
                />
                <el-table-column
                  prop="targetName"
                  :label="$t('townAggregationAudit.columns.targetName')"
                  min-width="140"
                />
                <el-table-column
                  prop="status"
                  ...
                  <template #default="{ row }">
                    <div class="action-buttons">
                      <el-button link type="info" @click="handleViewDetail(row)">
                        ...
                        {{ $t('townAggregationAudit.actions.viewDetail') }}
                      </el-button>
                      <el-button v-if="row.status === '1'" link type="success" @click="handleApprove(row)">
                        <i class="ri-check-line"></i>
                        {{ $t('demandAudit.actions.approve') }}
                      </el-button>
                      <el-button v-if="row.status === '1'||row.status === '2'" link type="danger" @click="handleReject(row)">
