  ...
  <div class="page-container">
    <div class="page-wrapper">
      ...
      <PageHeader
        ...
        :title="$t('allocation.menu.kebeleAllocation')"
        :subtitle="$t('allocation.menu.kebeleAllocation')"
      />
      ...
      <div class="content-wrapper">
        ...
        <!-- 数据列表 -->
        <InfoCard :title="$t('allocation.menu.kebeleAllocation')" icon="ri-file-list-3-line">
          <template #actions>
          ...
          <div class="mobile-card-list mobile-only">
            <div v-for="item in allocationList" :key="item.id" class="mobile-card">
              ...
              <div class="mobile-card-body">
                ...
                <div class="mobile-card-row">
                  <span class="label">{{ $t('allocation.kebele') }}:</span>
