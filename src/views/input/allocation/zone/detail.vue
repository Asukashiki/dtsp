<template>
  <div class="zone-allocation-detail-container">
    <el-page-header @back="handleBack" :title="$t('common.back')">
      <template #content>
        <span>{{ $t('allocation.allocationDetail') }}</span>
      </template>
    </el-page-header>
...
// 假设会有相应的API接口
import { getZoneAllocationDetail } from '@/api/allocation'
...
<style scoped>
.zone-allocation-detail-container {
  padding: 20px;
}
.detail-card {
  margin-top: 20px;
