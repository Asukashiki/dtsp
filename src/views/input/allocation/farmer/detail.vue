<template>
  <div class="farmer-allocation-detail-container">
    <el-page-header @back="handleBack" :title="$t('common.back')">
      <template #content>
        <span>{{ $t('allocation.farmerAllocationDetail') }}</span>
      </template>
    </el-page-header>
    ...
    <el-card v-loading="loading" class="detail-card">
      ...
      <el-descriptions :column="2" border>
        ...
        <el-descriptions-item :label="$t('allocation.farmer')">{{ detailData.main?.zoneName }}</el-descriptions-item>
...
import { getFarmerAllocationDetail } from '@/api/allocation'
...
<style scoped>
.farmer-allocation-detail-container {
  padding: 20px;
}
.detail-card {
  margin-top: 20px;
