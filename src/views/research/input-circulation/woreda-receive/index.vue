...
import { getWoredaReceiveList } from '@/api/inputCirculation'
...
const handleView = (row) => {
  router.push(`/research/input-circulation/woreda-receive/detail/${row.id}`)
}

const handleConfirm = (row) => {
  router.push(`/research/input-circulation/woreda-receive/confirm/${row.id}`)
}
