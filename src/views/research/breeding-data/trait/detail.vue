        ...
        <div class="info-card">
          ...
          <div class="card-body">
            <el-descriptions :column="2" border>
              <el-descriptions-item :label="$t('research.breedingData.trait.form.batchId')">{{ detailData.batchId }}</el-descriptions-item>
              <el-descriptions-item :label="$t('research.breedingData.trait.form.trialId')">{{ detailData.trialId }}</el-descriptions-item>
              <el-descriptions-item :label="$t('research.breedingData.trait.form.recordTime')">{{ detailData.recordTime }}</el-descriptions-item>
            </el-descriptions>
          </div>
        </div>
