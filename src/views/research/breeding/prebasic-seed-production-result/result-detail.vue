    ...
    <div class="info-card">
      <div class="card-header">
        <div class="card-title">
          ...
          <span>{{ $t('prebasicSeedProductionResult.detail') }}</span>
        </div>
      ...
      <div class="card-body">
        ...
        <div class="detail-section">
          <div class="section-title">
            ...
            {{ $t('prebasicSeedProductionResult.section.batchInfo') }}
          </div>
          <div class="detail-grid">
            <div class="detail-item">
              <span class="label">{{ $t('prebasicSeedProductionResult.columns.resultId') }}:</span>
              <span class="value">{{ data.resultId }}</span>
            </div>
            <div class="detail-item">
            ...
            <div class="detail-item">
              <span class="label">{{ $t('prebasicSeedProductionResult.columns.produceBatchName') }}:</span>
              <span class="value">{{ data.produceBatchName }}</span>
            </div>
            <div class="detail-item">
              <span class="label">{{ $t('prebasicSeedProductionResult.columns.varietyName') }}:</span>
              <span class="value">{{ data.varietyName }}</span>
            </div>
            <div class="detail-item">
              <span class="label">{{ $t('prebasicSeedProductionResult.form.breedBatchName') }}:</span>
              <span class="value">{{ data.breedBatchName }}</span>
            </div>
            <div class="detail-item">
              <span class="label">{{ $t('prebasicSeedProductionResult.form.trialName') }}:</span>
              <span class="value">{{ data.trialName }}</span>
            </div>
            <div class="detail-item">
              <span class="label">{{ $t('prebasicSeedProductionResult.form.fromSeedLevel') }}:</span>
              <span class="value">{{ data.fromSeedLevel }}</span>
            </div>
            <div class="detail-item">
              <span class="label">{{ $t('prebasicSeedProductionResult.form.toSeedLevel') }}:</span>
        ...
        <div class="detail-section">
          ...
          <div class="detail-grid">
            <div class="detail-item">
              ...
              <span class="value">{{ data.outputQuantity }} kg</span>
            </div>
            <div class="detail-item">
