      ...
      <div class="page-header">
        <div class="header-left">
          ...
          <div class="header-content">
            <h1 class="page-title">{{ $t('research.c1Propagation.auditDetail') }}</h1>
          </div>
        </div>
      </div>
          ...
          <div class="card-body">
            <el-descriptions :column="2" border>
              <el-descriptions-item :label="$t('research.c1Propagation.form.applicantOrgType')">
                {{ detailData.applicantOrgType ? $t(`research.c1Propagation.orgType.${detailData.applicantOrgType}`) :
                '-' }}
          ...
          <div class="card-body">
            <el-descriptions :column="2" border>
              ...
              <el-descriptions-item :label="$t('research.c1Propagation.form.demandQuantity')">
                <span style="font-weight: 500; color: #009A44;">{{ detailData.demandQuantity || '-' }}</span>
                <span v-if="detailData.demandQuantity"
                  style="margin-left: 4px; color: #909399; font-size: 13px;">kg</span>
              </el-descriptions-item>
            ...
            <el-descriptions :column="2" border>
              <el-descriptions-item :label="$t('research.c1Propagation.form.auditResult')">
                <el-tag :type="detailData.auditResult === 'approved' ? 'success' : 'danger'">
                  {{ detailData.auditResult ? $t(`research.c1Propagation.auditResult.${detailData.auditResult}`) : '-'
                  }}
                </el-tag>
              </el-descriptions-item>
        ...
        <div class="info-card">
          <div class="card-header">
            <div class="card-title">
              ...
              <span>{{ $t('research.c1Propagation.form.operatorInfo') }}</span>
            </div>
          </div>
          <div class="card-body">
            <el-descriptions :column="2" border>
...
import { getC1PropagationAuditById } from '@/api/c1Propagation'
