...
export const getRegistrationAuditPage = (params) => {
  return request({
    url: '/input/registration/audit/page',
    method: 'post',
    data: params
  })
}
...
export const approveRegistration = (id, version, remark) => {
  return request({
    url: '/input/registration/audit/approve',
    method: 'post',
...
export const rejectRegistration = (id, version, auditOpinion, remark) => {
  return request({
    url: '/input/registration/audit/reject',
    method: 'post',
...
export const getAuditRecordList = (enterpriseId) => {
  return request({
    url: '/input/registration/audit/list',
    method: 'get',
    params: { enterpriseId }
  })
}
