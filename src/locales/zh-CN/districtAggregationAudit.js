export default {
  ...
  adjustment: {
    title: 'ZONE LEVEL - 调整来自 Woreda 的需求',
    index: '#',
    emptyTitle: '请选择一条明细',
    emptyTip: '点击调整或查看历史后，可在此处管理单条需求明细。',
    woredaName: 'Woreda 名称',
    inputType: '投入品类型',
    category: '类别',
    variety: '品种',
    season: '季节',
    receivedDemand: 'Woreda 上报需求',
    adjustedDemand: 'Zone 调整后需求',
    currentAdjustedDemand: '当前 Zone 调整后需求',
    newAdjustedDemand: '新的 Zone 调整后需求',
