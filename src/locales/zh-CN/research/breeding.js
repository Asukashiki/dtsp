...
export default {
  ...
  seed: {
    ...
    production: {
      ...
      subtitle: '记录 breeder seed production data，确保种子繁育过程可追溯',
      list: 'Breeder seed production data list',
      add: '新增 breeder seed production data',
      detail: 'Breeder seed production data details',
      delete: '删除 breeder seed production data',
      deleteConfirm: '确定删除该 breeder seed production data 吗?',
      deleteSuccess: '删除成功',
      addSuccess: '新增成功',
      ...
      filterByDate: '按 Production Date 筛选',
      allVarieties: '全部品种',
      ...
      placeholder: {
        ...
        time: '请选择 Production Date',
        landName: '请输入 Plot Name',
      ...
      rules: {
        ...
        timeRequired: '请选择 Production Date',
        landNameRequired: '请输入 Plot Name',
      ...
      result: {
        ...
        add: '新增 breeder seed data collection',
