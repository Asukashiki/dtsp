    ...
    feedback: '信息反馈',
      ...
      stockCheck: {
        ...
        messages: {
          ...
          deleteSuccess: '删除成功',
          approveConfirm: '审核通过后系统将自动调整库存，是否继续？',
          approveTitle: '确认审核通过',
          deleteConfirm: '确认删除该盘点单？',
          cancelConfirm: '确认取消该盘点单？',
          submitConfirm: '提交后不可修改，确认提交？',
          selectWarehouseToLoad: '请选择仓库以加载商品明细',
          noInventoryItems: '该仓库暂无库存商品',
          noItemsForCheck: '该仓库无商品，无法盘点',
        }
      },
      stockCheckReview: {
        title: '盘点审核',
