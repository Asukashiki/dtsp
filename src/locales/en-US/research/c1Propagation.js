...
export default {
  // Page titles
  title: 'C1 Seed Propagation Application',
  subtitle: 'Union/Cooperative applies for C1 seed propagation',
  auditTitle: 'C1 Seed Propagation Audit',
  auditSubtitle: 'OIA reviews C1 seed propagation applications',
