...
export default {
  ...
  seed: {
    ...
    production: {
      ...
      list: 'Breeder seed production data list',
      add: 'Add',
      detail: 'Breeder seed production data details',
      delete: 'Delete breeder seed production data',
      deleteConfirm: 'Are you sure to delete this breeder seed production data?',
      deleteSuccess: 'Deleted Successfully',
      addSuccess: 'Added Successfully',

      searchPlaceholder: 'Search variety name',
      filterByVariety: 'Filter by Variety',
      filterByDate: 'Filter by Production Date',
      ...
      placeholder: {
        ...
        time: 'Please select production date',
        landName: 'Please enter plot name',
      ...
      rules: {
        ...
        timeRequired: 'Please select production date',
        landNameRequired: 'Please enter plot name',
      ...
      result: {
        ...
        title: 'Breeder seed data collection',
        add: 'Add breeder seed data collection',
        list: 'Breeder seed data collection list',
    ...
    ose: {
      ...
      rules: {
        ...
        oseNameRequired: 'Please enter detailed address',
        regionCodeRequired: 'Please select region',
        regionCodeRequired: 'Please enter contact person name',
