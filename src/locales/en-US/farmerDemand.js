export default {
  ...
  form: {
    ...
    inputCategory: 'Sub Category',
    inputType: 'Main Category',
    season: 'Season',
  ...
  placeholder: {
    ...
    inputCategory: 'Please select sub category',
    inputType: 'Please select main category',
    season: 'Please select season',
    cropLand: 'Please enter crop land',
    variety: 'Please select variety',
  ...
  rules: {
    ...
    inputCategoryRequired: 'Please select sub category',
    inputTypeRequired: 'Please select main category',
    seasonRequired: 'Please select season',
    cropLandRequired: 'Please enter crop land',
    varietyRequired: 'Please select variety',
